...
public class BowyeryBowItem extends BowItem {
    ...
    public BowyeryBowItem(Properties properties, double dmgMod, boolean inf, boolean fire) {
    ...
    public boolean canDraw(ItemStack stack, PlayerEntity player) {
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn, Hand handIn) {
        ...
        boolean flag = canDraw(itemstack, playerIn);
    ...
    public void onPlayerStoppedUsing(ItemStack stack, World worldIn, LivingEntity entityLiving, int timeLeft) {
        if (entityLiving instanceof PlayerEntity) {
            ...
            boolean flag = canDraw(stack, playerentity);
